...
cost_lp_impression event_usage_impression cpm_impression_cost contract_month]
	...
	def update_simulation_records
		...
		week_seating_capacity = (event_per_year.to_f/weeks) * daily_seating_capacity
		month_seating_capacity = (event_per_year.to_f/months) * daily_seating_capacity
		day_seating_capacity = (daily_seating_capacity * (event_per_year.to_f / 365))
		...
		day_attendance_event = (avg_attendance_event * (event_per_year.to_f / 365))
		...
		wifi_lp_day_login = (wifi_lp_per_day_login.to_f * (event_per_year.to_f / 365))
		...
		lp_rev_day_total = (lp_rev_per_day_total.to_f * (event_per_year.to_f / 365))
		...
		user_impression_day = (user_impression_per_day.to_f * (event_per_year.to_f / 365))
		...
		cpm_impression_per_day = user_impression_per_day * cpm_impression_cost
		cpm_impression_day = cpm_impression_per_day * (event_per_year.to_f / 365)
		...
		wifi_annual_day_total = (wifi_annual_total.to_f/365)
		self.update_columns(
